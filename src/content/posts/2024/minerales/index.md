...
- Las deficiencias/toxicidades de todos los minerales son bastante similares e incluyen un cuadro general de **debilidad, nauseas, pérdida de apetito y alteraciones del ritmo cardíaco (taquicardias)**, así que sólo mencionaré los síntomas más específicos.
...
### Calcio
- **Funciones:** Formación de **huesos y dientes**. También: coagulación de la sangre, contracción muscular, regulación del ritmo cardíaco, neurotransmisor.
- **Fuentes:** Presente en **lácteos** (fuente principal aunque baja biodisponiblidad, ~30%). También en: sardinas en conserva (alta BD), almendras (baja BD, ~20%), col, espinacas, acelgas (baja BD las tres y en especial muy baja en las espinacas por la presencia de **oxalatos y fitatos** que se adhieren al calcio y no permiten su absorción).
...
### Cloro
- **Funciones:** Es un **electrolito** (tiene carga eléctrica) lo que le confiere propiedades de **regulador** de líquidos, nutrientes y pH. También: forma parte de los **jugos digestivos**.
...
### Fósforo
- **Funciones:** Junto con el calcio, formación de huesos y dientes. También: cofactor enzimático, regulación pH sanguíneo, función muscular, producción de: neurotransmisores, ADN, ARN y ATP.
...
### Magnesio
- **Funciones:** También es un componente de los huesos y cofactor en más de 300 reacciones enzimáticas, por lo que tiene efectos en casi todos los sistemas del cuerpo, a destacar: absorción de vitamina D y calcio, regulación de glucosa y presión sanguínea, relajación muscular, producción de neurotransmisores.
...
### Potasio
- **Funciones:** Es un electrolito como cloro y sodio, actua como regulador de fluidos, pH y nutrientes a nivel **intracelular**, co-actuando con el sodio (regulador extracelular). También: función muscular, mantenimiento de la presión sanguínea. 
...
- **Fuentes:** Presente en huevos, lácteos y carne.

### Cobre
- **Funciones:** Varias actividades enzimáticas, necesario para la absorción del hierro y la síntesis de colágeno.
- **Fuentes:** Se almacena en huesos y tejidos, lo obtenemos de la proteína.

### Cromo
- **Funciones:** Aumenta la acción de la insulina, interviene en la absorción de hidratos, proteínas y grasas.
- **Fuentes:** Presente en cereales integrales.

### Flúor
- **Funciones:** Formación huesos y dientes. 
- **Fuentes:** Lo obtenemos principalmente del agua (fluorada) y la pasta dentrífica.

### Hierro
- **Funciones:** Principal componente de la hemoglobina (proteína transportadora de oxígeno de los glóbulos rojos).
...
### Manganeso
- **Funciones:** Coenzima que interviene en la absorción de hidratos, proteínas y grasas. Colabora con la vitamina K en la cicatrización de heridas.
- **Fuentes:** Se almacena principalmente en los huesos y se encuentra en una gran variedad de alimentos.

### Molibdeno
- **Funciones:** Componente de diversas enzimas que rompen los enlaces de proteínas, alcohol, drogas, toxinas, purinas y sulfitos.
- **Fuentes:** Presente en legumbres y cereales integrales.

### Níquel
- **Funciones:** Coenzima en diversas reacciones.
- **Fuentes:** Se encuentra en alimentos de orígen vegetal que lo absorben del suelo.

### Selenio
- **Funciones:** Parte de las **selenoproteínas** que intervienen en la formación de ADN y ofrecen protección contra el daño celular y las infecciones. Relacionado con la función tiroide. 
...
### Yodo
- **Funciones:** Formación de las hormonas tiroideas **tiroxina y triyodotironina**, necesarias para la producción de ciertas proteínas y enzimas y regular el metabolismo.
